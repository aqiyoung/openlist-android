...
| **老板账号** | liyang / ******** (role=0 admin, base_path=/) |
...
| v0.3.36 | 47 | 服务器地址配置 + 测试连接 + 下拉刷新/搜索/排序 |
| v0.3.37 | 48 | 管理功能(4 Tab) + 文件操作(新建/重命名/删除) + 记住密码恢复 |
| v0.3.38 | 49 | 文件预览完善(图片缩放/音视频/PDF/文本) + API 路由修正 |
| v0.3.39 | 50 | UI 全面重做 - iOS 26 风格(大圆角/高alpha玻璃/暖色光晕) |
